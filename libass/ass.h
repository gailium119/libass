 ...
 */
ASS_EXTERN ASS_DEPRECATED("use 'ass_set_pixel_aspect' instead")
 ...
 * \return success
 */
ASS_EXTERN ASS_DEPRECATED("it does nothing")
 ...
 */
ASS_EXTERN int ass_track_set_feature(ASS_Track *track, ASS_Feature feature, int enable);
